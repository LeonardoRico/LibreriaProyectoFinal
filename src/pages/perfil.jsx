        ...
        <div
          ...
          <div class="">
            ...
            <form>
              ...
              <h2 class="text-center mt-1 font-semibold dark:text-gray-300">Actualiza tu perfil y tu foto
              </h2>
              <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                <div class="w-full  mb-4 mt-6">
                  <label for="" class="mb-2 dark:text-gray-300">Nombres</label>
                  <input type="text"
              ...
              <div class="w-full rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                <button type="submit" class="w-full p-4">Actualizar</button>
              </div>
            </form>
          </div>
        </div>
